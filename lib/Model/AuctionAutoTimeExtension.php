...
/**
 * AuctionAutoTimeExtension Class Doc Comment
 *
 * @category Class
 * @package  Jetract
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuctionAutoTimeExtension implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuctionAutoTimeExtension';
    ...
    public function setMargin($margin)
    {
        ...
        if (!is_null($margin) && ($margin > 120)) {
            throw new \InvalidArgumentException('invalid value for $margin when calling AuctionAutoTimeExtension., must be smaller than or equal to 120.');
        }
        if (!is_null($margin) && ($margin < 0)) {
            throw new \InvalidArgumentException('invalid value for $margin when calling AuctionAutoTimeExtension., must be bigger than or equal to 0.');
        }
    ...
    public function setDuration($duration)
    {
        ...
        if (!is_null($duration) && ($duration > 120)) {
            throw new \InvalidArgumentException('invalid value for $duration when calling AuctionAutoTimeExtension., must be smaller than or equal to 120.');
        }
        if (!is_null($duration) && ($duration < 0)) {
            throw new \InvalidArgumentException('invalid value for $duration when calling AuctionAutoTimeExtension., must be bigger than or equal to 0.');
        }
