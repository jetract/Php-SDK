...
/**
 * AuctionUpdate Class Doc Comment
 *
 * @category Class
 * @package  Swagger\Client
 * @author   Swagger Codegen team
 * @link     https://github.com/swagger-api/swagger-codegen
 */
class AuctionUpdate implements ModelInterface, ArrayAccess
{
    ...
    /**
      ...
      * @var string
      */
    protected static $swaggerModelName = 'AuctionUpdate';
    ...
    protected static $swaggerTypes = [
        ...
        'auction_conditions' => 'object[]',
        'bidders' => 'object[]',
        'bidder_groups' => 'object[]',
     ...
     * Sets auction_items
     *
     * @param object[] $auction_items auction_items
     *
     * @return $this
     */
     ...
     *
     * @param object[] $auction_conditions auction_conditions
     *
     * @return $this
     */
     ...
     * Sets bidder_groups
     *
     * @param object[] $bidder_groups If you attach a bidder group to an auction. All members of this group can bid in this auction.
     *
     * @return $this
     */
    ...
    public function setDepartmentId($department_id)
    {
        ...
        if ((!preg_match("/^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/", $department_id))) {
            throw new \InvalidArgumentException("invalid value for $department_id when calling AuctionUpdate., must conform to the pattern /^[0-9a-fA-F]{8}-[0-9a-fA-F]{4}-4[0-9a-fA-F]{3}-[89abAB][0-9a-fA-F]{3}-[0-9a-fA-F]{12}$/.");
        }
     ...
     * Sets files
     *
     * @param object[] $files Attach files in the auction.
     *
     * @return $this
     */
     ...
     * Sets change_amounts
     *
     * @param object[] $change_amounts change_amounts
     *
     * @return $this
     */
