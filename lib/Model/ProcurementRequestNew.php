...
class ProcurementRequestNew implements ModelInterface, ArrayAccess
{
     ...
     *
     * @param string $department_code Department or Project Code.
     *
     * @return $this
     */
     ...
     * Sets code
     *
     * @param string $code Code of the procurement request. Max Length: 27
     *
     * @return $this
     */
     ...
     * Sets files
     *
     * @param object[] $files Attach files in the procurement request.
     *
     * @return $this
     */
